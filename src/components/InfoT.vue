<template>
  ...
  <svg
    ...
    viewBox="17 17 54.589806 52.330627"
    :x="`${coords.x}%`"
    :y="`${coords.y}%`"
    version="1.1"
    id="svg57">
    ...
    <g
      class="ldl-scale"
      id="g55"
      transform="matrix(0.68236768,0,0,0.65412678,10.176334,10.458551)">
      <g
        class="ldl-ani"
        id="g53">
        <linearGradient
        ...
        <metadata
          ...
          <d:tags>message,sns,msg,texting,information,communication,mention,hint,notify</d:tags>
          <d:license>by</d:license>
          <d:slug>hcp9qw</d:slug>
        </metadata>
      </g>
    </g>
  </svg>
